            ...
            <div class="col-lg-4 col-md-6 mb-all-40">
                ...
                <div class="product-thumbnail">
                    <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                        <a class="active" data-toggle="tab" href="#thumb1"><img src="img/products/p1.jpg" alt="product-thumbnail"></a>
                        <a data-toggle="tab" href="#thumb2"><img src="img/products/p5.jpg" alt="product-thumbnail"></a>
                        <a data-toggle="tab" href="#thumb3"><img src="img/products/p3.jpg" alt="product-thumbnail"></a>
                        <a data-toggle="tab" href="#thumb4"><img src="img/products/p7.jpg" alt="product-thumbnail"></a>
                    </div>
                </div>
                <!-- Thumbnail image end -->
            </div>
                    ...
                    <div class="tab-content thumb-content">
                        ...
                        <div id="review" class="tab-pane fade">
                            ...
                            <div class="review">
                                ...
                                <h4 class="review-mini-title">makali</h4>
                                <ul class="review-list">
                                    ...
                                    <li>
                                        ...
                                        <i class="fa fa-star-o"></i>
                                        <i class="fa fa-star-o"></i>
                                        <label>Review by <a href="https://themeforest.net/user/makali">makali</a></label>
                                    </li>
                                    <!-- Single Review List End -->
                                    <!-- Single Review List Start -->
                                    <li>
