...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>Home-5 || Makali Cosmetics and Beauty eCommerce Bootstrap 4 Template</title>
        ...
        <!-- 7-stroke fonts css -->
        <link rel="stylesheet" href="<?php echo $BASE_URL;?>/css/pe-icon-7-stroke.min.css">
        <!-- Nice select css -->
        ...
        <!-- Main css -->
        <link rel="stylesheet" href="<?php echo $BASE_URL;?>/css/style.css?<?php echo time();?>">
        <!-- Responsive css -->
